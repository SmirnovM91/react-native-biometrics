...
RCT_EXPORT_METHOD(simplePrompt: (NSString *)promptMessage 
  :(NSString *)fingerprint_message
                  :(NSString *)fingerprint_cancel
                  :(NSString *)fingerprint_hint
                  :(NSString *)fingerprint_recognized
                  :(NSString *)fingerprint_not_recognized
