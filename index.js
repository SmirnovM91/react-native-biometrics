...
export default {
   ...
   * rejects if the user fails or cancels
   */
  simplePrompt: (promptMessage, fingerprint_message, fingerprint_cancel, fingerprint_hint, fingerprint_recognized, fingerprint_not_recognized) => {
    return ReactNativeBiometrics.simplePrompt(promptMessage, fingerprint_message, fingerprint_cancel, fingerprint_hint, fingerprint_recognized, fingerprint_not_recognized)
  }
}
