...
public class ReactNativeBiometricsHelper extends FingerprintManager.AuthenticationCallback {
    ...
    private String fingerprint_recognized;
    private String fingerprint_not_recognized;

    private boolean selfCancelled;

    ReactNativeBiometricsHelper(FingerprintManager fingerprintManager, ImageView icon,
                                  TextView errorTextView, ReactNativeBiometricsCallback callback,String fingerprint_recognized,String fingerprint_not_recognized) {
    ...
    public void onAuthenticationFailed() {
        showError(fingerprint_not_recognized);
    }
    ...
    public void onAuthenticationSucceeded(final FingerprintManager.AuthenticationResult result) {
        ...
        errorTextView.setText(fingerprint_recognized);
        icon.postDelayed(new Runnable() {
            @Override
            public void run() {
