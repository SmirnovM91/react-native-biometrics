declare module 'react-native-biometrics' {
  ...
  * rejects if the user fails or cancels
  */
  function simplePrompt(promptMessage: string, fingerprint_message: string, fingerprint_cancel: string, fingerprint_hint: string, fingerprint_recognized: string, fingerprint_not_recognized: string): Promise<boolean>;
}
